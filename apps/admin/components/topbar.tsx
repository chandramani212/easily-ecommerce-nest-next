  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-[var(--admin-border)] bg-[var(--admin-card)] px-4 sm:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="ml-1 flex items-center gap-2.5 rounded-lg px-2 py-1.5 transition-colors hover:bg-[var(--admin-muted)]">
          <Avatar initials="AD" size="sm" />
          <div className="hidden sm:block">
            <p className="text-sm font-medium leading-none">Admin User</p>
            <p className="mt-0.5 text-xs text-[var(--admin-fg)]/50">admin@shopease.com</p>
          </div>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="hidden opacity-40 sm:block">
            <path d="m6 9 6 6 6-6" />
          </svg>
        </div>
      </div>
