...
export function ProductDetail({ product }: { product: Product }) {
  ...
  const descriptionContent =
    descriptionText || colorList.length > 0 ? (
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p>
          ...
          figures below are a rough guide only and can change depending on handling costs and
          supplier location.
        </p>
      </div>
      <div className="overflow-hidden rounded-lg border border-[var(--border)]">
        <table className="w-full text-sm">
          <tbody>
            {[
              ["up to 5 kg", "$8.50", "up to 50 kg", "$22.50"],
              ["up to 10 kg", "$10.00", "up to 100 kg", "$40.00"],
              ["up to 20 kg", "$16.00", "Pallet", "$110.00"],
            ].map((row) => (
              <tr key={row[0]} className="border-t border-[var(--border)] first:border-t-0">
                <td className="px-4 py-2.5">{row[0]}</td>
                <td className="px-4 py-2.5 font-medium text-[var(--foreground)]">{row[1]}</td>
                <td className="px-4 py-2.5">{row[2]}</td>
                <td className="px-4 py-2.5 font-medium text-[var(--foreground)]">{row[3]}</td>
              </tr>
            ))}
          </tbody>
        </table>
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <p>
          ...
          can&apos;t reproduce solid colour tints, so any tinted areas of your artwork will need
          to be converted to a solid colour.
        </p>
      </div>
      <div>
        <h4 className="mb-1.5 font-semibold text-[var(--foreground)]">
        ...
        <p>
          ...
          cannot be used for screen printing, engraving or debossing.
        </p>
      </div>
      <div>
        <h4 className="mb-1.5 font-semibold text-[var(--foreground)]">
  ...
  return (
    <>
            ...
            */}
            ...
            <div className="mt-6">
              ...
              <p className="mt-2 text-xs text-[var(--foreground)]/50">
                Please note all prices are based on plain stock and do not include origination,
                delivery, or duty where applicable.
              </p>
            </div>
      ...
      {/* Tab sections - Description & Specs, Delivery, Artwork */}
          ...
          <ProductTabs
            tabs={[
                ...
                ? [
                    {
                      ...
                      icon: (
                        <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m-8 4h10a2 2 0 002-2V7.5L14.5 3H7a2 2 0 00-2 2v13a2 2 0 002 2z" />
                        </svg>
                      ),
                    },
                  ]
                : []),
              {
                ...
                icon: (
                  <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a2 2 0 11-4 0m4 0H9m4 0h2.586a1 1 0 00.707-.293l2.414-2.414a1 1 0 00.293-.707V13a1 1 0 00-1-1h-5m-6 4a2 2 0 104 0" />
                  </svg>
                ),
              },
              {
